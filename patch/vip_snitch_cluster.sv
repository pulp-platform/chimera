...
#(
  ...
  localparam addr_t Scratch1Addr = `SNITCH_CLUSTER_PERIPHERAL_REG_SCRATCH_BASE_ADDR(1);
  localparam addr_t SnitchClClintSetAddr = `SNITCH_CLUSTER_PERIPHERAL_REG_CL_CLINT_SET_BASE_ADDR;
