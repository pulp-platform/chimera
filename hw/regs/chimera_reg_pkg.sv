...
package chimera_reg_pkg;
  ...
  parameter logic [BlockAw-1:0] CHIMERA_SNITCH_INTR_HANDLER_ADDR_OFFSET = 7'h4;
  parameter logic [BlockAw-1:0] CHIMERA_SNITCH_CLUSTER_0_RETURN_OFFSET = 7'h8;
  parameter logic [BlockAw-1:0] CHIMERA_SNITCH_CLUSTER_1_RETURN_OFFSET = 7'hc;
  parameter logic [BlockAw-1:0] CHIMERA_SNITCH_CLUSTER_2_RETURN_OFFSET = 7'h10;
  parameter logic [BlockAw-1:0] CHIMERA_SNITCH_CLUSTER_3_RETURN_OFFSET = 7'h14;
  parameter logic [BlockAw-1:0] CHIMERA_SNITCH_CLUSTER_4_RETURN_OFFSET = 7'h18;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_0_CLK_GATE_EN_OFFSET = 7'h1c;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_1_CLK_GATE_EN_OFFSET = 7'h20;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_2_CLK_GATE_EN_OFFSET = 7'h24;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_3_CLK_GATE_EN_OFFSET = 7'h28;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_4_CLK_GATE_EN_OFFSET = 7'h2c;
  parameter logic [BlockAw-1:0] CHIMERA_WIDE_MEM_CLUSTER_0_BYPASS_OFFSET = 7'h30;
  parameter logic [BlockAw-1:0] CHIMERA_WIDE_MEM_CLUSTER_1_BYPASS_OFFSET = 7'h34;
  parameter logic [BlockAw-1:0] CHIMERA_WIDE_MEM_CLUSTER_2_BYPASS_OFFSET = 7'h38;
  parameter logic [BlockAw-1:0] CHIMERA_WIDE_MEM_CLUSTER_3_BYPASS_OFFSET = 7'h3c;
  parameter logic [BlockAw-1:0] CHIMERA_WIDE_MEM_CLUSTER_4_BYPASS_OFFSET = 7'h40;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_0_BUSY_OFFSET = 7'h44;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_1_BUSY_OFFSET = 7'h48;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_2_BUSY_OFFSET = 7'h4c;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_3_BUSY_OFFSET = 7'h50;
  parameter logic [BlockAw-1:0] CHIMERA_CLUSTER_4_BUSY_OFFSET = 7'h54;
  ...
  parameter logic [3:0] CHIMERA_PERMIT[22] = '{
      ...
      4'b1111,  // index[ 1] CHIMERA_SNITCH_INTR_HANDLER_ADDR
      4'b1111,  // index[ 2] CHIMERA_SNITCH_CLUSTER_0_RETURN
      4'b1111,  // index[ 3] CHIMERA_SNITCH_CLUSTER_1_RETURN
      4'b1111,  // index[ 4] CHIMERA_SNITCH_CLUSTER_2_RETURN
      4'b1111,  // index[ 5] CHIMERA_SNITCH_CLUSTER_3_RETURN
      4'b1111,  // index[ 6] CHIMERA_SNITCH_CLUSTER_4_RETURN
      4'b0001,  // index[ 7] CHIMERA_CLUSTER_0_CLK_GATE_EN
      4'b0001,  // index[ 8] CHIMERA_CLUSTER_1_CLK_GATE_EN
      4'b0001,  // index[ 9] CHIMERA_CLUSTER_2_CLK_GATE_EN
      4'b0001,  // index[10] CHIMERA_CLUSTER_3_CLK_GATE_EN
      4'b0001,  // index[11] CHIMERA_CLUSTER_4_CLK_GATE_EN
      4'b0001,  // index[12] CHIMERA_WIDE_MEM_CLUSTER_0_BYPASS
      4'b0001,  // index[13] CHIMERA_WIDE_MEM_CLUSTER_1_BYPASS
      4'b0001,  // index[14] CHIMERA_WIDE_MEM_CLUSTER_2_BYPASS
      4'b0001,  // index[15] CHIMERA_WIDE_MEM_CLUSTER_3_BYPASS
      4'b0001,  // index[16] CHIMERA_WIDE_MEM_CLUSTER_4_BYPASS
      4'b0001,  // index[17] CHIMERA_CLUSTER_0_BUSY
      4'b0001,  // index[18] CHIMERA_CLUSTER_1_BUSY
      4'b0001,  // index[19] CHIMERA_CLUSTER_2_BUSY
      4'b0001,  // index[20] CHIMERA_CLUSTER_3_BUSY
      4'b0001  // index[21] CHIMERA_CLUSTER_4_BUSY
  };
