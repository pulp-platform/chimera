...
.PHONY: chim-all all
all: chim-all ## Alias for chim-all
chim-all: $(CHIM_ALL) ## Generate full chimera infrastructure

.PHONY: chim-clean clean
clean: chim-clean ## Alias for chim-clean
chim-clean clean: $(CHIM_CLEAN) ## Clean entire chimera infrastructure
